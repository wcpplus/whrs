  ...
  <el-drawer class="farm2-query-form" v-model="drawerWin" title="I am the title2" :append-to-body="true"
    ...
    <el-form :model="rules" label-width="auto" style="max-width: 600px">
      ...
      <el-form-item label="ID：">
        <el-input v-model="rules[6].value" />
      </el-form-item>
      <el-form-item label="状态：">
        <el-select v-model="rules[5].value" placeholder="请选择">
          <el-option label="临时" value="0" />
          <el-option label="持久" value="1" />
        </el-select>
      </el-form-item>
      ...
      <el-form-item label="原文件名：">
        <el-input v-model="rules[2].value" />
      </el-form-item>
      <el-form-item label="文件别名：">
        <el-input v-model="rules[3].value" />
      </el-form-item>
      <el-form-item label="外部ID：">
        <el-input v-model="rules[4].value" />
      </el-form-item>
      <el-form-item>
...
const rules = reactive<DataRule[]>([
  { key: 'NOTE', value: '', compara: 'like' },//0
  { key: 'RELATIVEPATH', value: '', compara: 'like' },//1
  { key: 'FILENAME', value: '', compara: 'like' },//2
  { key: 'TITLE', value: '', compara: 'like' },//3
  { key: 'APPID', value: '', compara: 'like' },//4
  { key: 'STATE', value: '', compara: '=' },//5
  { key: 'ID', value: '', compara: '=' },//6
]);
