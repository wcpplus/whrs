<template>
          ...
          <el-main>
            ...
            <div class="farm2-data-table">
              <el-table v-loading="loadingFlag" :data="dataResult.data" :stripe="true"
                ...
                <el-table-column sortable="custom" prop="KEYID" label="编码"  min-width="120" />
  ...
  <!--高级查询表单-->
  <AuthFamily_form_query></AuthFamily_form_query>
  <!--数据实体表单-->
  <AuthFamily_form_data></AuthFamily_form_data>
</template>
...
import AuthFamily_form_query from './components/authfamily_form_query.vue';
import AuthFamily_form_data from './components/authfamily_form_data.vue';
...
//---------------------------------------------------------
//路由信息：
//import authfamily_page from "@/views/system/authfamily/authfamily_page.vue";
// {
//     path: "authfamily",
//     name: "authfamily_page",
//     component: authfamily_page,
//     meta: { title: "岗位族" },
//   },
//---------------------------------------------------------
...
const doDataQuery = async (query?: DataQuery) => {
  farm2Request.search('api/authfamily/query', Object.assign(dataQuery, query), loadingFlag)
