...
const rules = reactive<DataRule[]>([
      { key: 'CTIME', value: '', compara: 'like' },//0
      { key: 'ACTIONTYPE', value: '', compara: 'like' },//0
      { key: 'OBJTYPE', value: '', compara: 'like' },//0
      { key: 'OBJID', value: '', compara: 'like' },//0
      { key: 'USERIP', value: '', compara: 'like' },//0
