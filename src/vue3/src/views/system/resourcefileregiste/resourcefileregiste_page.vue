<template>
          ...
          <el-main>
            ...
            <div class="farm2-data-table">
              <el-table v-loading="loadingFlag" :data="dataResult.data" :stripe="true"
                ...
                <el-table-column sortable="custom" prop="FILEID" label="附件id"  min-width="120" />
  ...
  <!--高级查询表单-->
  <ResourceFileRegiste_form_query></ResourceFileRegiste_form_query>
  <!--数据实体表单-->
  <ResourceFileRegiste_form_data></ResourceFileRegiste_form_data>
</template>
...
import ResourceFileRegiste_form_query from './components/resourcefileregiste_form_query.vue';
import ResourceFileRegiste_form_data from './components/resourcefileregiste_form_data.vue';
