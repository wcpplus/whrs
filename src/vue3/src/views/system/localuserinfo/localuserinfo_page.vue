<template>
          ...
          <el-main>
            ...
            <div class="farm2-data-table">
              <el-table v-loading="loadingFlag" :data="dataResult.data" :stripe="true"
                ...
                <el-table-column sortable="custom" prop="SEX" label="SEX" min-width="120" />
                <el-table-column sortable="custom" prop="BIRTHDATE" label="生日" min-width="120" />
                <el-table-column sortable="custom" prop="PHONECODE" label="移动电话" min-width="120" />
                <el-table-column sortable="custom" prop="EMPTIME" label="入职时间" min-width="120" />
                <el-table-column sortable="custom" prop="EMAIL" label="电子邮箱" min-width="120" />
                <el-table-column sortable="custom" prop="IDCODE" label="身份证" min-width="120" />
                <el-table-column sortable="custom" prop="CITYCODE" label="参保城市" min-width="120" />
                <el-table-column sortable="custom" prop="PAN" label="银行卡号" min-width="120" />
                <el-table-column sortable="custom" prop="CONTRACTFID" label="劳动合同ID" min-width="120" />
                <el-table-column sortable="custom" prop="EQFID" label="学历证书ID" min-width="120" />
                <el-table-column sortable="custom" prop="DEGFID" label="学位证书ID" min-width="120" />
                <el-table-column sortable="custom" prop="MERFID" label="体检报告ID" min-width="120" />
                <el-table-column sortable="custom" prop="ICARDFID" label="身份证复印件ID" min-width="120" />
                <el-table-column sortable="custom" prop="PROCESS" label="完善度" min-width="120" />
  ...
  <!--高级查询表单-->
  <LocalUserInfo_form_query></LocalUserInfo_form_query>
  <!--数据实体表单-->
...
import LocalUserInfo_form_query from './components/localuserinfo_form_query.vue';
import LocalUserInfo_form_data from './components/localuserinfo_form_data.vue';
...
//---------------------------------------------------------
//路由信息：
//import localuserinfo_page from "@/views/system/localuserinfo/localuserinfo_page.vue";
// {
//     path: "localuserinfo",
//     name: "localuserinfo_page",
//     component: localuserinfo_page,
//     meta: { title: "用户信息" },
//   },
//---------------------------------------------------------
...
const doDataQuery = async (query?: DataQuery) => {
  farm2Request.search('api/localuserinfo/query', Object.assign(dataQuery, query), loadingFlag)
