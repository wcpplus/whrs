  ...
  <el-drawer class="farm2-query-form" v-model="drawerWin" title="I am the title2" :append-to-body="true"
    ...
    <el-form :model="rules" label-width="auto" style="max-width: 600px">
     ...
     <el-form-item label="分组名称：">    
        <el-input v-model="rules[5].value" />
      </el-form-item>
...
const rules = reactive<DataRule[]>([
      ...
      { key: 'NAME', value: '', compara: 'like' },//0
      { key: 'PKEY', value: '', compara: 'like' },//0
      { key: 'PVALUE', value: '', compara: 'like' },//0
      { key: 'DESCRIBES', value: '', compara: 'like' },//0
      { key: 'GNAME', value: '', compara: 'like' },//0
      { key: 'VERSION', value: '', compara: 'like' },//0
]);
