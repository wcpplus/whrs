<template>
          ...
          <el-main>
            ...
            <div class="farm2-data-table">
              <el-table v-loading="loadingFlag" :data="dataResult.data" :stripe="true"
                ...
                <el-table-column sortable="custom" prop="ETIME" label="修改时间"  min-width="120" />
                <el-table-column sortable="custom" prop="EUSERKEY" label="修改用户"  min-width="120" />
  ...
  <!--高级查询表单-->
  <AuthPtype_form_query></AuthPtype_form_query>
  <!--数据实体表单-->
...
import AuthPtype_form_query from './components/authptype_form_query.vue';
...
//---------------------------------------------------------
//路由信息：
//import authptype_page from "@/views/system/authptype/authptype_page.vue";
// {
//     path: "authptype",
//     name: "authptype_page",
//     component: authptype_page,
//     meta: { title: "岗位类别" },
//   },
//---------------------------------------------------------
