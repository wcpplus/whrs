<template>
      ...
      <el-container>
        <el-container>
          <el-header>
            ...
            <Data_querys placeholder="名称或IP" :isShowQueryPlus="true">
            </Data_querys>
          ...
          <el-main>
            ...
            <div class="farm2-data-table">
              <el-table v-loading="loadingFlag" :data="dataResult.data" :stripe="true"
                ...
                <el-table-column prop="loginId" label="登录ID*" min-width="200" />
                <el-table-column fixed="left" type="selection" width="55" />
                <el-table-column prop="ip" label="ip" min-width="120" />
                <el-table-column prop="name" label="名称" min-width="120" />
                <el-table-column prop="loginName" label="登录名" min-width="120" />
                <el-table-column prop="startTime" :formatter="dic.formatTimestamp" label="最早访问" min-width="140" />
                <el-table-column prop="endTime" :formatter="dic.formatTimestamp" label="最近访问" min-width="140" />
                <el-table-column prop="visitNum" label="请求量/分" min-width="140" />
  ...
  <!--高级查询表单-->
  <OnlineUser_form_query></OnlineUser_form_query>
  <!--数据实体表单-->
  <OnlineUser_form_data></OnlineUser_form_data>
</template>
...
import OnlineUser_form_query from './components/onlineuser_form_query.vue';
import OnlineUser_form_data from './components/onlineuser_form_data.vue';
...
//---------------------------------------------------------
//路由信息：
//import onlineuser_page from "@/views/system/onlineuser/onlineuser_page.vue";
// {
//     path: "onlineuser",
//     name: "onlineuser_page",
//     component: onlineuser_page,
//     meta: { title: "在线用户" },
//   },
//---------------------------------------------------------
...
const doDataQuery = async (query?: DataQuery) => {
  farm2Request.search('api/onlineuser/query', Object.assign(dataQuery, query), loadingFlag)
