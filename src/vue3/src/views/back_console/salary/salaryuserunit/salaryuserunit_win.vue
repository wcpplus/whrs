<template>
 <el-dialog v-if="state.dialogVisible" :append-to-body="true" style="background-color: rgb(248, 248, 250);"
          ...
          <el-main>
            ...
            <div class="farm2-data-table">
              <el-table v-loading="loadingFlag" :data="dataResult.data" :stripe="true"
                ...
                <el-table-column sortable="custom" prop="USERNAME" label="USERNAME"  min-width="120" />
                ...
                <el-table-column sortable="custom" prop="GROSSPAY" label="应发工资"  min-width="120" />
                <el-table-column sortable="custom" prop="NETPAY" label="实发工资"  min-width="120" />
                <el-table-column sortable="custom" prop="TAXAMOUNT" label="个人所得税"  min-width="120" />
  ...
  <!--高级查询表单-->
  <SalaryUserUnit_form_query></SalaryUserUnit_form_query>
  <!--数据实体表单-->
  <SalaryUserUnit_form_data></SalaryUserUnit_form_data>
  </el-dialog>
</template>
...
import SalaryUserUnit_form_query from './components/salaryuserunit_form_query.vue';
import SalaryUserUnit_form_data from './components/salaryuserunit_form_data.vue';
...
//---------------------------------------------------------
//路由信息：
//import salaryuserunit_page from "@/views/system/salaryuserunit/salaryuserunit_page.vue";
// {
//     path: "salaryuserunit",
//     name: "salaryuserunit_page",
//     component: salaryuserunit_page,
//     meta: { title: "用户薪资" },
//   },
//---------------------------------------------------------
...
const doDataQuery = async (query?: DataQuery) => {
  ...
  farm2Request.search('api/salaryuserunit/query', dataQuery, loadingFlag)
