...
//---------------------------------------------------------
//路由信息：
//import salaryuser_page from "@/views/system/salaryuser/salaryuser_page.vue";
// {
//     path: "salaryuser",
//     name: "salaryuser_page",
//     component: salaryuser_page,
//     meta: { title: "用户薪酬WHRS_SALARY_USER" },
//   },
//---------------------------------------------------------
...
const doDataQuery = async (query?: DataQuery) => {
  ...
  farm2Request.search('api/salaryuser/query', dataQuery, loadingFlag)
