<template>
  <el-dialog v-if="state.dialogVisible" :append-to-body="true" style="background-color: rgb(248, 248, 250);"
        ...
        <el-container>
          <el-container>
            <el-header>
              ...
              <Data_querys placeholder="名称"  :is-show-query-plus="false">
              </Data_querys>
            ...
            <el-main>
              ...
              <div class="farm2-data-table">
                <el-table v-loading="loadingFlag" :data="dataResult.data" :stripe="true"
                  ...
                  <el-table-column v-if="false" sortable="custom" prop="KEYCODE" label="KEYCODE" min-width="120" />
                  <el-table-column v-if="false" sortable="custom" prop="CTIME" label="创建时间" min-width="120" />
                  <el-table-column sortable="custom" prop="VAL" label="VAL" min-width="120" />
                  <el-table-column v-if="false" sortable="custom" prop="SHOWMODEL" label="是否显示" min-width="100" />
                  <el-table-column sortable="custom" prop="SALARYTIME" label="计薪周期" min-width="120" />
                  <el-table-column v-if="false" sortable="custom" prop="USERKEY" label="USERKEY" min-width="120" />
    ...
    <!--高级查询表单-->
    <SalaryUserItem_form_query></SalaryUserItem_form_query>
    <!--数据实体表单-->
    <SalaryUserItem_form_data></SalaryUserItem_form_data>
  </el-dialog>
</template>
...
import SalaryUserItem_form_query from './components/salaryuseritem_form_query.vue';
import SalaryUserItem_form_data from './components/salaryuseritem_form_data.vue';
...
//---------------------------------------------------------
//路由信息：
//import salaryuseritem_page from "@/views/system/salaryuseritem/salaryuseritem_page.vue";
// {
//     path: "salaryuseritem",
//     name: "salaryuseritem_page",
//     component: salaryuseritem_page,
//     meta: { title: "用户薪酬明细" },
//   },
//---------------------------------------------------------
...
const doDataQuery = async (query?: DataQuery) => {
  ...
  farm2Request.search('api/salaryuseritem/query', dataQuery, loadingFlag)
