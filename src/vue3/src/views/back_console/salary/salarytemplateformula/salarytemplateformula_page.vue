          ...
          <el-main>
            ...
            <div class="farm2-data-table">
              <el-table v-loading="loadingFlag" :data="dataResult.data" :stripe="true"
                ...
                <el-table-column sortable="custom" prop="RULEVAL" label="公式"  min-width="250" />
                <el-table-column sortable="custom" prop="VALNAME" label="结果名称"  min-width="120" />
                <el-table-column sortable="custom" prop="VALCODE" label="结果关键字"  min-width="120" />
                <el-table-column sortable="custom" prop="TEMPLATEID" label="TEMPLATEID"  min-width="120" />
                <el-table-column sortable="custom" prop="SHOWMODEL" label="是否显示"  min-width="100" />
                <el-table-column sortable="custom" prop="SORTCODE" label="排序"  min-width="120" />
                <el-table-column sortable="custom" prop="STEPCODE" label="步骤排序"  min-width="120" />
