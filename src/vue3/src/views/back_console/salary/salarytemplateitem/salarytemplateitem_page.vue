          ...
          <el-main>
            ...
            <div class="farm2-data-table">
              <el-table v-loading="loadingFlag" :data="dataResult.data" :stripe="true"
                ...
                <el-table-column sortable="custom" prop="DEFAULTVAL" label="默认值" min-width="120" />
                <el-table-column sortable="custom" prop="KEYCODE" label="关键字" min-width="120" />
                <el-table-column sortable="custom" prop="COMPONENTTYPE" label="类型" min-width="120" />
                <el-table-column sortable="custom" prop="SOURCEMODEL" label="来源类型" min-width="120" />
                <el-table-column sortable="custom" prop="USEROVER" label="用户覆盖" min-width="100" />
                ...
                <el-table-column sortable="custom" prop="SHOWMODEL" label="显示类型" min-width="100" />
