<template>
          ...
          <el-main>
            ...
            <div class="farm2-data-table">
              <el-table v-loading="loadingFlag" :data="dataResult.data" :stripe="true"
                ...
                <el-table-column sortable="custom" prop="PCONTENT" label="备注"  min-width="250" />
                <el-table-column sortable="custom" prop="SNODEID" label="源节点ID"  min-width="120" />
                <el-table-column sortable="custom" prop="TNODEID" label="目标节点ID"  min-width="120" />
                <el-table-column sortable="custom" prop="FLOWID" label="流程ID"  min-width="120" />
                <el-table-column sortable="custom" prop="EXPRESSION" label="布尔表达式"  min-width="250" />
  ...
  <!--高级查询表单-->
  <WdapFlowLink_form_query></WdapFlowLink_form_query>
  <!--数据实体表单-->
  <WdapFlowLink_form_data></WdapFlowLink_form_data>
</template>
...
import WdapFlowLink_form_query from './components/wdapflowlink_form_query.vue';
import WdapFlowLink_form_data from './components/wdapflowlink_form_data.vue';
...
//---------------------------------------------------------
//路由信息：
//import wdapflowlink_page from "@/views/system/wdapflowlink/wdapflowlink_page.vue";
// {
//     path: "wdapflowlink",
//     name: "wdapflowlink_page",
//     component: wdapflowlink_page,
//     meta: { title: "流程连线" },
//   },
//---------------------------------------------------------
...
const doDataQuery = async (query?: DataQuery) => {
  farm2Request.search('api/wdapflowlink/query', Object.assign(dataQuery, query), loadingFlag)
