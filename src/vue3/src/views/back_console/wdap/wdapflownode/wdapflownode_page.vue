<template>
          ...
          <el-main>
            ...
            <div class="farm2-data-table">
              <el-table v-loading="loadingFlag" :data="dataResult.data" :stripe="true"
                ...
                <el-table-column sortable="custom" prop="MODEL" label="绑定业务模型"  min-width="250" />
                <el-table-column sortable="custom" prop="RID" label="绑定业务模型ID"  min-width="120" />
  ...
  <!--高级查询表单-->
  <WdapFlowNode_form_query></WdapFlowNode_form_query>
  <!--数据实体表单-->
  <WdapFlowNode_form_data></WdapFlowNode_form_data>
</template>
...
import WdapFlowNode_form_query from './components/wdapflownode_form_query.vue';
import WdapFlowNode_form_data from './components/wdapflownode_form_data.vue';
...
//---------------------------------------------------------
//路由信息：
//import wdapflownode_page from "@/views/system/wdapflownode/wdapflownode_page.vue";
// {
//     path: "wdapflownode",
//     name: "wdapflownode_page",
//     component: wdapflownode_page,
//     meta: { title: "流程节点" },
//   },
//---------------------------------------------------------
...
const doDataQuery = async (query?: DataQuery) => {
  farm2Request.search('api/wdapflownode/query', Object.assign(dataQuery, query), loadingFlag)
