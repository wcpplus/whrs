<template>
          ...
          <el-main>
            ...
            <div class="farm2-data-table">
              <el-table v-loading="loadingFlag" :data="dataResult.data" :stripe="true"
                ...
                <el-table-column fixed="left" sortable="custom" prop="TITLE" label="标题" min-width="260" />
                ...
                <el-table-column sortable="custom" prop="STATE" :formatter="dic.formatSTATE" label="状态"
                  min-width="100" />
                ...
                <el-table-column fixed="right" label="操作" min-width="250">
                  <template #default="scope">
                    ...
                    <el-button link type="success" icon="Edit" size="small" @click="dataEditClick(scope.row)">
                      参数设置
                    </el-button>
  ...
  <!--高级查询表单-->
  <WdapConvertor_form_query></WdapConvertor_form_query>
  <!--数据实体表单-->
  <WdapConvertor_form_data></WdapConvertor_form_data>
</template>
...
import WdapConvertor_form_query from './components/wdapconvertor_form_query.vue';
import WdapConvertor_form_data from './components/wdapconvertor_form_data.vue';
